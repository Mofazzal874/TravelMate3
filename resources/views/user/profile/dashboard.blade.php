...
<div class="intro-y flex items-center mt-8">
    <h2 class="text-lg font-medium mr-auto">
            Return to <a href="{{route('home')}}" style="color:rgb(18, 130, 68);">Home</a>
    </h2>
</div>
<div>
    ...
    <div class="p-5">
        <div class="grid grid-cols-12 gap-5">
            ...
            <div class="col-span-12 xl:col-span-6">
                ...
                <a href="{{ route('user.profile.edit', $profile->id) }}" class="button  w-50 bg-theme-1 text-white mt-3">Update Information</a>
