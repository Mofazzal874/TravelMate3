...
@section('contents')
    <div style="margin:.5vw">
        ...
        <a href="{{ route('admin.places.create') }}"
            class="text-white float-right bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
            style="margin-top: 10px">Add A New Place</a>
        <hr />
                ...
                @if ($places->count() > 0)
                    @foreach ($places as $rs)
                        <tr>
                            ...
                            <td>
                                <div class="h-14 pt-5">
                                    <a href="{{ route('admin.places.show', $rs->id) }}" class="text-blue-800"><ion-icon
                                            name="eye-outline"></ion-icon></a>
                                    <a href="{{ route('admin.places.edit', $rs->id) }}"
                                        class="text-green-800 pl-2"><ion-icon name="create-outline"></ion-icon></a>
                                    <form action="{{ route('admin.places.destroy', $rs->id) }}" method="POST"
