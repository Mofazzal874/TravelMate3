        ...
        <div class="bg-[rgb(37,150,190)] text-black rounded-lg shadow-md px-6 py-8 border-4 border-black">
            ...
            <div class="flex flex-col lg:flex-row border-b border-gray-200 pb-5">
                ...
                <div class="w-32 h-32 lg:w-40 lg:h-40 flex-none rounded-full overflow-hidden mr-5">
                    <img alt="Profile Image" class="w-full h-full object-cover" src="{{$user->image ? asset('storage/' . $user->image) : ''}}">
                </div>
                <!-- Profile Bio -->
            ...
            <div class="grid grid-cols-12 gap-6">
                <div class="col-span-12 xl:col-span-6">
                    <div>
                        ...
                        <input type="text" class="input w-full border bg-gray-200 cursor-not-allowed mt-2" value="{{$user->city}}" disabled>
                    </div>
                    <div class="mt-3">
                        <label class="font-semibold">Postal Code</label>
                        <input type="text" class="input w-full bg-gray-200 border mt-2" value="{{$user->postal_code}}" disabled>
                    </div>
                    <div class="mt-3">
                    ...
                    <div class="mt-3">
                        ...
                        <input type="text" class="input w-full bg-gray-200 border mt-2" value="{{$user->skills}}" disabled>
                    </div>
                    <div class="mt-3">
                        <label class="font-semibold">Operating Area</label>
                        <input type="text" class="input w-full bg-gray-200 border mt-2" value="{{$tourGuide->operating_area}}" disabled>
                    </div>
                    <div class="mt-3">
                        <label class="font-semibold">Tour Types</label>
                        <input type="text" class="input w-full bg-gray-200 border mt-2" value="{{$tourGuide->tour_type}}" disabled>
                    </div>
                    <div class="mt-3">
                        <label class="font-semibold">Tourist Type</label>
                        <input type="text" class="input w-full bg-gray-200 border mt-2" value="{{$tourGuide->tourist_type}}" disabled>
                    </div>
                    <div class="mt-3">
                        <label class="font-semibold">Tourist Capacity</label>
                        <input type="text" class="input w-full bg-gray-200 border mt-2 mb-7" value="{{$tourGuide->tourist_capacity}}" disabled>
                    </div>
                </div>
                <div class="col-span-12 xl:col-span-6">
                    <div>
                        <label class="font-semibold">Status</label>
                        <input type="text" class="input w-full bg-gray-200 border mt-2" value="{{$user->status}}" disabled>
                    </div>
                    <div class="mt-3">
                        <label class="font-semibold">Address</label>
                    ...
                    <div class="mt-3">
                        ...
                        <input type="text" class="input w-full bg-gray-200 border mt-2" value="{{$user->gender}}" disabled>
                    </div>
                    <div class="mt-3">
                        <label class="font-semibold">Date Of Birth</label>
                        <input type="text" class="input w-full bg-gray-200 border mt-2" value="{{$user->dob}}" disabled>
                    </div>
                    <div class="mt-3">
                        <label class="font-semibold">Experience</label>
                        <input type="text" class="input w-full bg-gray-200 border mt-2" value="{{$user->experience}}" disabled>
                    </div>
                    <div class="mt-3">
                        <label class="font-semibold">Education</label>
                        <input type="text" class="input w-full bg-gray-200 border mt-2 mb-7" value="{{$user->education}}" disabled>
                    </div>
                    <div class="mt-3">
                        <label class="font-semibold">Price</label>
                        <input type="text" class="input w-full bg-gray-200 border mt-2 mb-7" value="{{$tourGuide->price}}" disabled>
                    </div>
                    <div class="mt-3">
                        <label class="font-semibold">Rating</label>
                        <input type="text" class="input w-full bg-gray-200 border mt-2 mb-7" value="{{$tourGuide->rating}}" disabled>
                    </div>
                </div>
            </div>
        </div>
